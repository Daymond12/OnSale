...
namespace OnSale.Web.Controllers
{
    public class AccountController : Controller
    {
        ...
        #region METODOS RESPECTO AL USUARIO
        ...
        public async Task<IActionResult> Register(AddUserViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user == null)
                {
                    ...
                    //LOS COMBOS SE DEBEN ARMAR DE NUEVO, SINO EN LA VISTA SE PIERDEN
                ...
                #region METODOS PARA REGISTRAR USUARIOS SIN CONFIRMACIÓN DE EMAIL
                ...
                Response response = _mailHelper.SendMail(model.Username, "Email confirmation", $"<h1>Email Confirmation</h1>" +
                    $"To allow the user, " +
                    $"please click in this link:<br><p><a href = \"{tokenLink}\">Confirm Email</a></p>");
        ...
        public async Task<IActionResult> ChangeUser()
        {
           //buscamos el usuario
            ...
            //al modificar el usuario debemos cargar el departamento y el pais
            //en este caso solo tenemos el codigo de ciudad así que se arma un muñeco
            //hacemos un busqueda hacia arriba
            ...
            //Buscamos el país con el departamento
        ...
        #region METODOS PARA RECUPERACIÓN DE PASSWORD
